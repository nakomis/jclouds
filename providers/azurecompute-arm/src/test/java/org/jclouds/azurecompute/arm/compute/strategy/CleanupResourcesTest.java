...
public class CleanupResourcesTest {
    ...
    public void testCleanupVirtualMachineNICs() {
        ...
        NetworkInterfaceCard nic = mockNic("id","prefix/resourceGroups/myGroupName/myIpAddress");
    ...
    public void testCaseInsensitiveCleanupVirtualMachineNICs() {
        VirtualMachine vm = mockVmWithNic("prefix/resourceGroups/myGroupName/myNicName");
        VirtualMachine vmUPPER = mockVmWithNic("prefix/resourceGroups/myGroupName/MYNICNAME");
        NetworkInterfaceCard nic = mockNic("id", "prefix/resourceGroups/myGroupName/myIpAddress");
        PublicIPAddress ipAddress = mockPublicIpAddress(ImmutableMap.of(AUTOGENERATED_IP_KEY, "true"));
        ...
        // Do call
        cleanupResources(api).cleanupVirtualMachineNICs(vmUPPER);
    ...
    public void testIgnoreNonJcloudsAvailabilitySetIfOrphaned() {
        IdReference availabilitySetRef = IdReference.create("prefix/resourceGroups/myGroupName/myAvailabilitySet");
        VirtualMachine vm = mockVmWithAvailabilitySet(availabilitySetRef);
        AvailabilitySet availabilitySet = mockAvailabilitySet(ImmutableMap.of("not-jclouds", "myval"));
        ...
        expect(availabilitySetApi.get("myAvailabilitySet")).andReturn(availabilitySet);
        // At this point we shoud *not* expect availabilitySetApi.delete to be called
    ...
    private static NetworkInterfaceCard mockNic(String id, String... publicIpIdRefs) {
